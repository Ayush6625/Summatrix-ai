...
export default async function SummaryPage(props: {
  ...
  const { title, summary_text, file_name, word_count,created_at,orignal_file_url } = summary;
    ...
    <div className="relative isolate min-h-screen bg-linear-to-b from-rose-50/40 to-white">
      ...
      <div className="container mx-auto flex flex-col gap-4">
        <div className="px-4 sm:px-6 lg:px-8 py-6 sm:py-12 lg:py-24">
          ...
          fileName={file_name}
          createdAt={created_at}
          orignalFileUrl={orignal_file_url}
     />}
  ...
  hover:bg-white/90 max-w-4xl mx-auto"
    ...
    bg-linear-to-br from-rose-50/50 via-orange-300 {/* Fixed here */}
